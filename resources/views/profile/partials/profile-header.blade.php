<div x-data="{ chosenAvatarId: '', avatarHovered: false }">
    ...
    <div class="relative">
        ...
        <div class="absolute bottom-10 left-12 flex flex-row items-center">
            @if ($user['avatar_id'])
                <div class="w-24 h-24 rounded-full  border-white dark:border-gray-800"
                    ...
                    <img
                        ...
                        alt="profile">
                    <div x-on:click="$dispatch('open-modal', 'test')" x-show="avatarHovered" x-transition.duration.400ms
