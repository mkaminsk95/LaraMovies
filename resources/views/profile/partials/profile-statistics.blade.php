<div class="py-3 flex flex-row flex-wrap justify-center items-center gap-4 sm:gap-8 bg-light-element-secondary dark:bg-dark-element-secondary text-base tracking-wider uppercase">
    <div class="flex flex-row items-center gap-1">
        <x-star class="h-[20px] w-[20px] sm:h-[28px] sm:w-[28px] md:h-[26px] md:w-[26px] text-light-text-secondary dark:text-dark-text-primary"></x-star>
        {{ __('messages.statistics_rated') }}: {{ $topRatings->count() }}
    </div>
    <div class="flex flex-row items-center gap-1">
        <svg class="inline-block h-[20px] w-[20px] sm:h-[28px] sm:w-[28px] md:h-[26px] md:w-[26px] text-light-text-secondary dark:text-dark-text-primary" viewBox="0 0 24 24"
