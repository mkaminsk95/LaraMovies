            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2">
                        ...
                        <button form="send-verification" class="underline text-sm text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-hover  dark:hover:text-dark-text-hover rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
