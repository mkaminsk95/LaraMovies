<x-layout>
    <div class="mt-12 mx-auto max-w-lg flex justify-center flex-col">
        <ul role="list" class="divide-y-4 divide-gray-100 dark:divide-gray-900 rounded">
            @foreach($paginatedMovies as $movie)
                <li class="flex gap-x-6 bg-white dark:bg-gray-800">
                    ...
                    <div class="flex flex-row flex-1 justify-between shrink-0 mt-3 rounded">
                        <div class="min-w-0">
                            <span class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-600">{{ $movie['title'] }}</span>
