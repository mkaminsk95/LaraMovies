    ...
    <div class="flex flex-col mx-auto max-w-3xl my-14 bg-light-element dark:bg-dark-element text-light-text-primary dark:text-dark-text-primary shadow-lg rounded">
        <div class="mx-20 my-16 sm:text-xl">
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-xl font-bold tracking-tight sm:text-2xl">{{ __('Create movie') }}</h2>
                <p class="mt-2 text-base leading-8 text-light-text-secondary dark:text-dark-text-secondary">{{ __('Fill in the form below to save a new movie.') }}</p>
            </div>
