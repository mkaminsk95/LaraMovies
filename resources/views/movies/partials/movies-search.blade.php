...
<form x-show="opened">
    <div class="flex flex-col fixed overflow-scroll inset-0 z-10 md:sticky md:top-[30px] md:mb-[135px] md:mt-[57px] pt-8 md:pt-2 pb-6 px-10 h-full md:h-fit md:w-[320px] lg:w-[375px]
