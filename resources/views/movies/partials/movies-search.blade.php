...
<form x-show="opened">
    <div class="flex flex-col fixed inset-0 z-10 md:sticky md:top-12 md:mt-[52px] pt-8 md:pt-2 pb-6 px-10 h-full md:h-fit md:w-[320px] lg:w-[350px]
            bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-300 rounded shadow-lg dark:shadow-shadow-color border border-1 border-gray-300 dark:border-gray-700">
