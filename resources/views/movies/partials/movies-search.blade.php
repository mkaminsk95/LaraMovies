...
<form x-show="opened">
    <div class="flex flex-col fixed overflow-auto inset-0 px-10 md:px-1 z-10 md:sticky md:top-[30px] md:mb-[135px] md:mt-[57px] pt-8 md:pt-0 pb-6 h-full md:h-fit md:w-[250px] semi_lg:w-[280px] lg:w-[305px]
        ...
        <x-inputs.label class="mt-2" for="sorting">{{ __('Sorting') }}</x-inputs.label>
        <x-inputs.select class="shadow-none" id="sorting" name="sorting" :options="$sortingOptions" :value="$query['sorting'] ?? ''"/>
