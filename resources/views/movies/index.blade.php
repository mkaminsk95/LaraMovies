                        ...
                        <div class="flex flex-col justify-between min-w-0">
                            ...
                            <div>
                                @foreach($movie->genres as $genre)
                                    <x-genre-block class="text-xs text-gray-500 p-1 mr-1 bg-gray-700">{{ $genre['name'] }}</x-genre-block>
                                @endforeach
                            </div>
                        </div>
                        <div class="mr-5 mt-2">
                            <x-star class="inline align-top leading-none text-yellow-600" width="20px" height="20px" :filled="true"/>
