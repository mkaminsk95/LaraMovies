@props(['perViewExtraSmall' => 4, 'perViewSmall' => 4.7, 'perViewMedium' => 5.6, 'perViewLarge' => 6.4])
...
<div {{ $attributes }} x-data="window.initializeCarousel()" @glidemounted.window="topValue = calculateHeight()" @resize.window="topValue = calculateHeight()">
    <div class="glide mt-5" data-carousel-settings='{"perViewExtraSmall": {{ $perViewExtraSmall }}, "perViewSmall": {{ $perViewSmall }}, "perViewMedium": {{ $perViewMedium }}, "perViewLarge": {{ $perViewLarge }}}'>
        ...
        <div class="leading-0 p-[2px] absolute start-0 -translate-x-[24px] sm:-translate-x-[30px] md:-translate-x-[42px] md:-translate-x-[20px] border bg-gray-300/80 hover:bg-gray-200 dark:border-gray-500 rounded-full" data-glide-el="controls"
             :style="{top: topValue}">
        ...
        <div class="leading-0 p-[2px] absolute end-0 translate-x-[24px] sm:translate-x-[30px] md:translate-x-[42px] md:translate-x-[20px] border bg-gray-300/80 hover:bg-gray-200 dark:border-gray-500 rounded-full shadow" data-glide-el="controls"
             :style="{top: topValue}">
            <button data-glide-dir=">">
